...
return [
     ...
     *
     */
    'title' => getenv("APP_NAME") . ' Installer',
    'next' => 'Next Step',
    'back' => 'Previous',
    'finish' => 'Install',
    'forms' => [
    ...
    'environment' => [
        ...
        'wizard' => [
            ...
            'form' => [
                ...
                'server_web_ip_label' => 'Server IP',
                'server_web_ip_placeholder' => 'Server IP',
                ...
                'db_password_hash_label' => 'Database Password Hash',
                'db_password_hash_placeholder' => 'Database Password Hash',
     ...
     */
    'installed' => [
        'success_log_message' => getenv("APP_NAME") . ' INSTALLED successfully on ',
    ],
    ...
    'updater' => [
        ...
        'log' => [
            'success_message' => getenv("APP_NAME") . ' UPDATED successfully on ',
        ],
    ],
];
