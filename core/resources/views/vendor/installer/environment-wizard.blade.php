        ...
        <form method="post" action="{{ route('LaravelInstaller::environmentSaveWizard') }}" class="tabs-wrap">
            <div class="tab" id="tab1content">
                ...
                <div class="form-group {{ $errors->has('license_name') ? ' has-error ' : '' }}">
                    <label for="app_name">
                        {{ trans('installer_messages.environment.wizard.form.license_label') }}
                    </label>
                    <input type="text" name="app_name" id="license_name" value=""
                           placeholder="{{ trans('installer_messages.environment.wizard.form.license_placeholder') }}"/>
                ...
                <div class="form-group {{ $errors->has('server_web_ip') ? ' has-error ' : '' }}">
                    <label for="server_web_ip">
                        {{ trans('installer_messages.environment.wizard.form.server_web_ip_label') }}
                    </label>
                    <input type="text" name="server_web_ip" id="server_web_ip" value=""
                           placeholder="{{ trans('installer_messages.environment.wizard.form.server_web_ip_placeholder') }}"/>
                    @if ($errors->has('server_web_ip'))
                        <span class="error-block">
                            <i class="fa fa-fw fa-exclamation-triangle" aria-hidden="true"></i>
                            {{ $errors->first('server_web_ip') }}
                        </span>
                    @endif
                </div>
            ...
            <div class="tab" id="tab2content">
                ...
                <div class="form-group {{ $errors->has('database_connection') ? ' has-error ' : '' }}">
                    ...
                    <select name="database_connection" id="database_connection">
                        <option
                            value="mysql">{{ trans('installer_messages.environment.wizard.form.db_connection_label_mysql') }}</option>
                        <option
                        ...
                        <option value="sqlsrv"
                                selected>{{ trans('installer_messages.environment.wizard.form.db_connection_label_sqlsrv') }}</option>
                    </select>
                ...
                <div class="form-group {{ $errors->has('database_hostname') ? ' has-error ' : '' }}">
                    ...
                    <input type="text" name="database_hostname" id="database_hostname" value=""
                ...
                <div class="form-group {{ $errors->has('database_port') ? ' has-error ' : '' }}">
                    ...
                    <input type="number" name="database_port" id="database_port" value=""
                ...
                <div class="form-group {{ $errors->has('database_password_hash') ? ' has-error ' : '' }}">
                    <label for="database_password">
                        {{ trans('installer_messages.environment.wizard.form.db_password_hash_label') }}
                    </label>
                    <input type="password" name="database_password" id="database_password_hash" value=""
                           placeholder="{{ trans('installer_messages.environment.wizard.form.db_password_hash_placeholder') }}"/>
                    @if ($errors->has('database_password_hash'))
                        <span class="error-block">
                            <i class="fa fa-fw fa-exclamation-triangle" aria-hidden="true"></i>
                            {{ $errors->first('database_password_hash') }}
                        </span>
                    @endif
                </div>
