    ...
    <div class="content">
        ...
        <div class="block block-rounded">
            <div class="block-header block-header-default">
                <h3 class="block-title">Editing Character</h3>

                <div class="block-options">
                    <a href="/admin/characters" class="btn btn-sm btn-alt-primary">
                        ...
                        <div class="block-content">
                            ...
                            <div id="blockUi">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-3">
                                        <img src="{{ asset('assets/game_img/chars') }}/{{ $character->ItemID }}.jpg"
                                    ...
                                    <div class="col-lg-9">
                                            ...
                                            <span class="input-group-text">
                                             Price
                                                ...
                                                <input type="number" class="form-control" id="PriceP"
                                                       name="PriceP" value="{{$character->PriceP}}">
                                            ...
                                            <span class="input-group-text">
                                             Price
                                                ...
                                                <input type="number" class="form-control" id="GPriceP"
                                                       name="PriceP" value="{{$character->GPriceP}}">
                                        ...
                                        <div class="mb-4">
                                            <label class="form-label" for="IsNew">Is New <span class="text-danger">*</span></label>
                                            <select class="form-select" id="IsNew" name="IsNew">
                                                <option value="">--- Please select --</option>
                                                <option value="0" {{ (!$character->IsNew) ? "selected" : "" }} >No</option>
                                                <option value="1" {{ ($character->IsNew) ? "selected" : "" }}>Yes</option>
                                            </select>
                                        </div>
                                        ...
                                        <div class="mb-4">
                                            ...
                                            <select class="form-select" id="IsVisible" name="IsVisible">
                                                <option value="">--- Please select --</option>
                                                <option value="0" {{ (!$character->IsVisible) ? "selected" : "" }} >No</option>
                                                <option value="1" {{ ($character->IsVisible) ? "selected" : "" }}>Yes</option>
                                            </select>

                                            <small class="text-warning">* Attention! If you hidden this item, you can't more see in this panel!</small>
                                        ...
                                        <div class="mb-4">
                                            ...
                                            <textarea class="input-group-text" name="Description" id="Description"
                                                      cols="150" rows="5">{{ $character->Description }}</textarea>
                                            </div>
                                        </div>

                                        <div class="input-group">
                                            <button type="submit" class="btn btn-alt-success me-1 mb-3" id="submit-button"
                                                    name="submit-button">
...
@section('js')
    ...
    <script>
        ...
        submitButton.click(function (event) {
            ...
            var skillID = <?php echo $character->ItemID; ?>;
            var apiUrl = `/api/v1/characters/update/${skillID}`;
