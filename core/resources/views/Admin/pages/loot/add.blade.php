    ...
    <div class="content">
        ...
        <div class="block block-rounded">
            <div class="block-header block-header-default">
                <h3 class="block-title">Add new Loot</h3>
                        ...
                        <div class="block-content">
                            ...
                            <div id="blockUi">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-3">
                                        <div id="ImageLoad">
                                            <img src='{{ asset('assets/game_img/game_items') }}/skull.png'
                                    ...
                                    <div class="col-lg-9">
                                        ...
                                        <div class="mb-4">
                                            ...
                                            <select class="js-select2 form-select" id="LootID"
                                                ...
                                                @foreach($getAllLootID as $lootID)
                                                    <option value="{{$lootID->ItemID}}">{{$lootID->ItemID}}
                                                        - {{$lootID->Name}}</option>
                                                @endforeach
                                            </select>
                                        ...
                                        <div class="mb-4">
                                            <label class="form-label" for="Chance">Item
                                                <span class="text-primary">Multiple Choose</span></label>

                                            <select class="js-select2 form-select"
                                                    id="ItemID" name="ItemID[]"
                                                    style="width: 100%;"
                                                    data-placeholder="--- Choose multiple items to spawn ---" multiple
                                        ...
                                        <div class="mb-4">
                                            ...
                                            <input type="text" class="js-rangeslider" id="Chance" name="Chance"
                                                   value="50" data-min="0" data-max="100">
                                        </div>
...
@section('js')
    ...
    <script>
        ...
        submitButton.click(function (event) {
            ...
            // Convert the 'itemID' array to a JSON string
            var itemIDArray = ItemID.map(Number);
            ...
            var apiUrl = `/api/v1/lootdata/create`;
